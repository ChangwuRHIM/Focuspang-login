...
WebUI.setText(findTestObject('Object Repository/Class_notice/Page_focuspang ai for teacher/input__field-r4b'), '테스트공지')

WebUI.click(findTestObject('Object Repository/Class_notice/Page_focuspang ai for teacher/p'))
