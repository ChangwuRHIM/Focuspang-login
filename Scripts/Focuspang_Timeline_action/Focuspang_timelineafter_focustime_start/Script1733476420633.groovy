...
WebUI.click(findTestObject('Object Repository/focustime_start/Page_focuspang ai for teacher/span__chakra-checkbox__control css-c9a4w'))

WebUI.click(findTestObject('Object Repository/focustime_start/Page_focuspang ai for teacher/button__1_2_3'))
