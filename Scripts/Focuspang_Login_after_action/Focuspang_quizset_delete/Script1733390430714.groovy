...
WebUI.click(findTestObject('Object Repository/quizset/Page_focuspang ai for teacher/div__1_2'))

WebUI.click(findTestObject('Object Repository/quizset/Page_focuspang ai for teacher/button__1_2'))
